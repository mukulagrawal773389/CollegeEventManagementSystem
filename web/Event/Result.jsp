...
<body>
    ...
    <main>
        ...
        <div class="main-box">
        <div>
        <h1 id="main-h1" class="heading-pri"> Event Results </h1>
        <p class="sub-heading"> Manage your events result </p>
        </div>
        <div>
            <div><a class="btn" href="Aresult.jsp"> Add Result</a></div>
        </div>
         </div>
        <div class="content">
...
out.print("<table style='border:0px solid #333; font-size: 1.4rem; padding: 1rem 4rem; width: 100%; height: 54vh;"
...
while(rs.next())
{
    ...
    out.print("<td><a href=Result_del.jsp?em="+rs.getString(5)+"> <img src=\"delete.png\" width=\"22\" heignt=\"18\"> </a></td>");
    out.print("</tr>");
